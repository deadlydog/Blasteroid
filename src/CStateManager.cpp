...
void CStateManager::SetState(void (*Function)(void* vpFunction, EPurpose ePurpose), void* vpOptionalDataToPass)
{
...
void CStateManager::ShutdownCurrentStateAndSetNextState(void (*Function)(void* vpFunction, EPurpose ePurpose), void* vpOptionalDataToPass)
{
	SGameState* spState;	// Temp pointer to Game States
