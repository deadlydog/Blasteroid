/* TODO
- Investigate Shutdown function, as Function3 is never shutdown in the Test.cpp
- Add function to return previous state function which was called (state that called the current state)
*/
...
class CStateManager
{
	public:
		...
		void SetState(void (*Function)(void* vpFunction, EPurpose ePurpose), void* vpOptionalDataToPass = 0);
		...
		void ShutdownCurrentStateAndSetNextState(void (*Function)(void* vpFunction, EPurpose ePurpose), void* vpOptionalDataToPass = 0);
