...
BOOL cInputDevice::GetLock(unsigned char Num)
{
  return m_Locks[Num];
}

BOOL cInputDevice::SetLock(unsigned char Num, BOOL State)
{
  m_Locks[Num] = State;
  return TRUE;
}
...
BOOL cInputDevice::SetKeyState(unsigned char Num, BOOL State)
{
  m_State[Num] = State;
  return TRUE;
}
...
BOOL cInputDevice::SetButtonState(unsigned char Num, BOOL State)
{
  if(m_Type == MOUSE) {
