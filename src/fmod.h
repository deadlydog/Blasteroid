...
#define FMOD_VERSION    0x00040037
...
#define FMOD_INIT_NONREALTIME             0x00000001 /* All platforms - Output is driven with System::update. */
...
typedef enum
{
    ...
    FMOD_CHANNEL_CALLBACKTYPE_MAX,                  /* Maximum number of callback types. */
...
FMOD_RESULT F_API FMOD_System_SetSoftwareFormat      (FMOD_SYSTEM *system, int samplerate, FMOD_SOUND_FORMAT format, int numoutputchannels, int maxinputchannels);
FMOD_RESULT F_API FMOD_System_GetSoftwareFormat      (FMOD_SYSTEM *system, int *samplerate, FMOD_SOUND_FORMAT *format, int *numoutputchannels, int *maxinputchannels, int *bits);
